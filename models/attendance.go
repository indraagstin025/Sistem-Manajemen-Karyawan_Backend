...
type Attendance struct {
	...
	Status    string             `json:"status" bson:"status,omitempty" validate:"omitempty,oneof=Hadir Telat Izin Sakit Cuti Alpha Belum Absen"` 
...
type AttendanceCreatePayload struct {
	...
	Status   string `json:"status" validate:"required,oneof=Hadir Telat Izin Sakit Cuti Alpha Belum Absen"`
...
type AttendanceUpdatePayload struct {
	...
	Status   string `json:"status,omitempty" validate:"omitempty,oneof=Hadir Telat Izin Sakit Cuti Alpha Belum Absen"`
